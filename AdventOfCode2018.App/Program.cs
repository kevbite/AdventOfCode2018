...
";
            ...
            Puzzle puzzle = null;
            while ((puzzle=Puzzle.ReadNext(stringReader)) != null)
            {
                puzzles.Add(puzzle);
            }

            var possible = puzzles.Select(x => day16.GetPossibleOpCodes(x.Before, x.Instructions, x.After));
            var result1 = possible
                .Where(x => x.Length >= 3)
                .Count();


            Console.WriteLine("Day 16 part 1 result: " + result1);
...
##.## => .";
        ...
        private static void Day10()
        {
            ...
            var input = @"position=<-30302,  30614> velocity=< 3, -3>
...
position=<-20127, -30341> velocity=< 2,  3>";
            var watchSky = day10.WatchSky(input);

            Console.WriteLine("Day 10 part 1 result:");
            Console.WriteLine(watchSky.sky);
            Console.WriteLine($"Day 10 part 2 result: {watchSky.seconds}");
            Console.ReadKey();
        }
...
Step S must be finished before step G can begin.";
            ...
            var result1 = sleighInstructions.FindOrder(input);
            var result2 = new Workers(5).Complete(input);

            Console.WriteLine("Day 7 part 1 result: " + result1);
            Console.WriteLine("Day 7 part 2 result: " + result2);
        }
        private static void Day5()
        {
            var input = @"";

            var polymer = new Polymer();

            var result1 = polymer.React(input);
            var result2 = polymer.FindShortest(input);

            Console.WriteLine("Day 5 part 1 result: " + result1);
